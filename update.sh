...
if [[ ! -n "${DISTRO}" ]] ; then
	echo "ERROR: Wrong -d was not set."
	exit 1
fi
if [[ ! -n "${USERName}" ]]; then
	echo "ERROR: Wrong -n was not set."
	exit 1
fi
if [[ ! -n "${USEREmail}" ]]; then
	echo "ERROR: Wrong -e was not set."
	exit 1
fi
if [[ ! -n "${FTP3}" ]]; then
	echo "ERROR: Wrong -f was not set."
	exit 1
fi
